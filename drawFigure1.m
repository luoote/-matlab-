...
%绘制角速度线图
axes(handles.suduplot);					%以下注释内容同上
...
xlabel('mm');
ylabel('mm');
set(handles.siganchuxing,'XLim',[-50 350]);	%设置x轴和y轴的坐标范围
set(handles.siganchuxing,'YLim',[-20 200]);
grid on;